...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUsername) {
            throw (0, http_errors_1.default)(409, 'Username already exists. Please choose a different username');
        }
        const existingEmail = yield user_1.default.findOne({ email: email }).exec();
        if (existingEmail) {
            throw (0, http_errors_1.default)(409, 'A user with this email already exists. Please log in instead');
        }
